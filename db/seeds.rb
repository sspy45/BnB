...
pic4 = Picture.create!(name: "Tree Top Fortress", url: "http://res.cloudinary.com/dkw3fxfzr/image/upload/v1495612892/TreeHouseINT_ssgk7f.png", imageable_id: location10.id, imageable_type: "Location" )
pic5 = Picture.create!(name: "Ice Kingdom", url: "http://res.cloudinary.com/dkw3fxfzr/image/upload/v1495612889/OldXSX3_fimo4s.jpg", imageable_id: location10.id, imageable_type: "Location" )
